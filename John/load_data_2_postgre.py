...
SVI2018_df = pd.read_csv('C:/Users/86bur/dataclass/Better_Census_Bureau/Data/SVI2018_US.csv',sep=',',lineterminator='\r',header=0,encoding='latin1',low_memory=False)
Texas_county_df = pd.read_csv('C:/Users/86bur/dataclass/Better_Census_Bureau/Data/Texas_COUNTY.csv',sep=',',lineterminator='\r',header=0,encoding='latin1',low_memory=False)
texas_houston_df = pd.read_csv('C:/Users/86bur/dataclass/Better_Census_Bureau/Data/Texas_Houston.csv',sep=',',lineterminator='\r',header=0,encoding='latin1',low_memory=False)
texas_df = pd.read_csv('C:/Users/86bur/dataclass/Better_Census_Bureau/Data/Texas.csv',sep=',',lineterminator='\r',header=0,encoding='latin1',low_memory=False)
